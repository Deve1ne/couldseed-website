    ...
    <section id="album" class="flex flex-col items-center justify-center w-full bg-white text-gray-800 px-[10vw] md:py-4 transition-all">
      <div class="w-full max-w-3xl flex flex-col items-center gap-4 md:gap-6">
        <div class="w-full flex justify-center">
          <a href="https://orcd.co/couldseed" target="_blank" rel="noopener noreferrer" class="w-48 h-48 md:w-64 md:h-64 bg-green-100 rounded-2xl flex items-center justify-center shadow-lg animate-fade-in overflow-hidden">
